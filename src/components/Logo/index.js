  ...
  return (
    <Link to="/">
      <Svg
        ...
        viewBox="35.979 13.989 428.042 122.021"
        style={{
          background: '0 0',
        }}
      ...
      >
        <defs>
          ...
          >
            ...
            <stop offset={1} stopColor="#51e1e1" />
          </linearGradient>
          <filter
          ...
          >
            ...
            <feComposite
              ...
              result="shadow"
            />
            <feOffset dx={3.3} dy={-4} in="SourceGraphic" result="offset-1" />
            <feOffset dx={-3.3} dy={4} in="shadow" result="offset-2" />
            <feMerge>
